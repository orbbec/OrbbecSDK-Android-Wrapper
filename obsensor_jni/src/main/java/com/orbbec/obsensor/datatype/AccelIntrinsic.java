...
public class AccelIntrinsic extends DataType {
    ...
    protected boolean parseBytesImpl(byte[] bytes) {
        ...
        offset += length;
        mGravity = DataUtilities.bytesToDoubles(DataUtilities.subBytes(bytes, offset, length), 3);
        offset += length;
